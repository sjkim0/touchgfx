...
const uint8_t* video_tesst_bin_start;
...
void setupVideoDecoder(touchgfx::HAL& hal)
{
    ...
    setupVideo(static_cast<touchgfx::HALSDL2&>(hal).localFileName(videoFileName, 400, "tesst.bin"), &video_tesst_bin_start, video_tesst_bin_length);
}
